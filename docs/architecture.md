...
│  ┄ transcribing ┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄  │
│    src/transcribe.py                                                                            │
│    ffmpeg: video ──▶ 16 kHz mono WAV ──▶ split into 55-second chunks (silence-aware)           │
...
│    FRAMES_PER_MINUTE env var  (default: 12 = 1 frame per 5 s)                                  │
│                                                                                                 │
│  ┄ analyzing_images ┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄  │
...
│    user: transcript + visual context blocks (shared timestamps)                                 │ GPT-4.1  400K TPM
│    Markdown: Tutorial · How-to Guide · Reference · Explanation  (auto-language) ◀──────────── │ S0 GlobalStandard
│    embed_frame_images()  resolves ![caption](frame_NNNNNN.png) ──▶ base64 data URIs           │
│                                                                                                 │
